// modules/logbook/routes/logbookRoutes.js
...
logbookRoutes.post('/create', authenticateStudentToken, logbookController.create_logbook_entry_post);

// Get route for getting logbook entries by student ID
logbookRoutes.get('/entries', authenticateStudentToken, logbookController.get_logbook_entries_by_student_get);
